...
public enum ModArmorMaterials implements ArmorMaterial {
    worldwalker("worldwalker", 26, new int[]{ 5, 7, 5, 4 }, 25,
            SoundEvents.ARMOR_EQUIP_LEATHER, 1f, 0f, () -> Ingredient.of(ModItems.grain_of_skint.get()));
    ...
    public String getName() {
        return Heart_of_the_Galaxy.MOD_ID + ":" + this.name;
    }
